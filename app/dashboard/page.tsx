        ...
        <DashboardLayout userEmail={user.email} userName={user.user_metadata.name}>
            <div className="p-6 lg:p-8">
                <div className="mx-auto max-w-8xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
                        <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-100 shadow-lg shadow-slate-200/50 p-4 sm:p-6 transition-all duration-300 hover:shadow-xl hover:shadow-slate-200/60">
                            <div className="flex items-center gap-3 sm:gap-4">
                                <div className="shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-linear-to-br from-green-100 to-green-200 flex items-center justify-center">
                        ...
                        <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-100 shadow-lg shadow-slate-200/50 p-4 sm:p-6 transition-all duration-300 hover:shadow-xl hover:shadow-slate-200/60">
                            <div className="flex items-center gap-3 sm:gap-4">
                                <div className="shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-linear-to-br from-red-100 to-red-200 flex items-center justify-center">
                        ...
                        <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-100 shadow-lg shadow-slate-200/50 p-4 sm:p-6 transition-all duration-300 hover:shadow-xl hover:shadow-slate-200/60">
                            <div className="flex items-center gap-3 sm:gap-4">
                                <div className="shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-linear-to-br from-indigo-100 to-indigo-200 flex items-center justify-center">
                        ...
                        <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-100 shadow-lg shadow-slate-200/50 p-4 sm:p-6 transition-all duration-300 hover:shadow-xl hover:shadow-slate-200/60">
                            <div className="flex items-center gap-3 sm:gap-4">
                                <div className="shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-linear-to-br from-slate-100 to-slate-200 flex items-center justify-center">
                    ...
                    {/* Quick Actions */}
                    <div className="bg-linear-to-r from-indigo-600 via-violet-600 to-purple-600 shadow-xl shadow-indigo-200 rounded-2xl p-4 sm:p-6 text-white">
