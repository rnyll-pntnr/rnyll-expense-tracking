        ...
        <DashboardLayout userEmail={user.email} userName={user.user_metadata.name}>
            <div className="p-6 lg:p-8">
                <div className="mx-auto max-w-8xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8">
                        <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-100 shadow-lg shadow-slate-200/50 p-4 sm:p-6 transition-all duration-300 hover:shadow-xl hover:shadow-slate-200/60">
                            <div className="flex items-center gap-3 sm:gap-4">
                                <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-green-100 to-green-200 flex items-center justify-center">
                                ...
                                <div className="flex-1">
                                    ...
                                    <dd className="text-lg sm:text-xl font-bold text-green-600">{currencySymbol}{formatCurrency(stats.totalIncome, currencyCode)}</dd>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-100 shadow-lg shadow-slate-200/50 p-4 sm:p-6 transition-all duration-300 hover:shadow-xl hover:shadow-slate-200/60">
                            <div className="flex items-center gap-3 sm:gap-4">
                                <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-red-100 to-red-200 flex items-center justify-center">
                                ...
                                <div className="flex-1">
                                    ...
                                    <dd className="text-lg sm:text-xl font-bold text-red-600">{currencySymbol}{formatCurrency(stats.totalExpense, currencyCode)}</dd>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-100 shadow-lg shadow-slate-200/50 p-4 sm:p-6 transition-all duration-300 hover:shadow-xl hover:shadow-slate-200/60">
                            <div className="flex items-center gap-3 sm:gap-4">
                                <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-indigo-100 to-indigo-200 flex items-center justify-center">
                                ...
                                <div className="flex-1">
                                    ...
                                    <dd className={`text-lg sm:text-xl font-bold ${stats.balance >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                        ...
                        <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-100 shadow-lg shadow-slate-200/50 p-4 sm:p-6 transition-all duration-300 hover:shadow-xl hover:shadow-slate-200/60">
                            <div className="flex items-center gap-3 sm:gap-4">
                                <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-slate-100 to-slate-200 flex items-center justify-center">
                                ...
                                <div className="flex-1">
                                    ...
                                    <dd className="text-lg sm:text-xl font-bold text-gray-900">{currencySymbol}{formatCurrency(avgDaily, currencyCode)}</dd>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Recent Transactions */}
                    <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-slate-100 shadow-lg shadow-slate-200/50 p-4 sm:p-6 mb-8">
                        ...
                        {recentTransactions.length === 0 ? (
                            ...
                            <ul className="divide-y divide-slate-100">
                                {recentTransactions.map((transaction) => (
                                    <li key={transaction.id} className="py-3 sm:py-3.5">
                    ...
                    {/* Quick Actions */}
                    <div className="bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 shadow-xl shadow-indigo-200 rounded-2xl p-4 sm:p-6 text-white">
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                            <div>
                                <h3 className="text-base sm:text-lg font-semibold">Ready to track your expenses?</h3>
                            ...
                            <Link
                                href="/dashboard/expenses"
                                className="px-5 py-2.5 bg-white text-indigo-600 rounded-xl text-sm font-semibold hover:bg-indigo-50 transition-all duration-200 shadow-lg text-center"
                            >
                                Add Transaction
                            </Link>
                        </div>
