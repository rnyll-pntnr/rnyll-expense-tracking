                ...
                <div className="mx-auto max-w-7xl">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-5 w-0 flex-1">
                                        <dl>
                                            ...
                                            <dd className="text-lg font-semibold text-green-600">{currencySymbol}{stats.totalIncome.toFixed(2)}</dd>
                                        </dl>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-5 w-0 flex-1">
                                        <dl>
                                            ...
                                            <dd className="text-lg font-semibold text-red-600">{currencySymbol}{stats.totalExpense.toFixed(2)}</dd>
                                        </dl>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-5 w-0 flex-1">
                                        <dl>
                                            ...
                                            <dd className={`text-lg font-semibold ${stats.balance >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-5 w-0 flex-1">
                                        <dl>
                                            ...
                                            <dd className="text-lg font-semibold text-gray-900">{currencySymbol}{avgDaily.toFixed(2)}</dd>
                                        </dl>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="bg-gradient-to-r from-indigo-500 to-purple-600 shadow rounded-lg p-6 text-white">
                        <div className="flex items-start justify-between">
                            <div>
                                <h3 className="text-lg font-medium">Ready to track your expenses?</h3>
                            ...
                            <Link
                                href="/dashboard/expenses"
                                className="ml-4 px-4 py-2 bg-white text-indigo-600 rounded-md text-sm font-medium hover:bg-indigo-50 transition-colors whitespace-nowrap"
                            >
                                Add Transaction
                            </Link>
                        </div>
